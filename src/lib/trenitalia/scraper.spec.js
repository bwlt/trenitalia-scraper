...
describe(`${__filename}`, () => {
  ...
  it('works', async () => {
    ...
    expect(solutions[0]).toEqual(expect.objectContaining({
    ...
    expect(solutions[0].fromTime.toISOString()).toBe('2017-06-18T04:45:00.000Z')
    expect(solutions[0].toTime.toISOString()).toBe('2017-06-18T08:06:00.000Z')
    expect(solutions[0].duration.toISOString()).toBe('PT3H21M')

    expect(solutions[1]).toEqual(expect.objectContaining({
      from: 'Milano Centrale',
      to: 'Pordenone',
      // duration: '3h 30\'',
      trains: [
    ...
    expect(solutions[1].fromTime.toISOString()).toBe('2017-06-18T05:45:00.000Z')
